...
namespace KOP.DAL.Migrations
{
    ...
    [Migration("20250206123159_AddAssessmentInterpretations")]
    partial class AddAssessmentInterpretations
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("KOP.DAL.Entities.AssessmentEntities.AssessmentResult", b =>
                {
                    ...
                    b.HasOne("KOP.DAL.Entities.User", "Judged")
                        .WithMany()
                        .HasForeignKey("JudgedId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
